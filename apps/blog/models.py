...
class Post(models.Model):
    ...
    description = RichTextField(config_name='awsome_ckeditor', verbose_name='Краткое описание',
                                max_length=500)
    text = RichTextField(config_name='awsome_ckeditor', verbose_name='Полный текст записи')
